...
const research = [
  {
    ...
    researchYr: "",
    citebox: "popup1",
    image: "assets/images/research-page/website.jpg",
    citation: {
      vancouver:
...

  {
    ...
    researchYr: "",
    citebox: "popup2",
    image: "assets/images/research-page/mobile.jpg",
    citation: {
      vancouver:
...

  {
    ...
    researchYr: "",
    citebox: "popup3",
    image: "assets/images/research-page/android.jpg",
    citation: {
      vancouver:
...

  {
    ...
    researchYr: "",
    citebox: "popup4",
    image: "assets/images/research-page/ios.jpg",
    citation: {
      vancouver:
...

  {
    ...
    researchYr: "",
    citebox: "popup5",
    image: "assets/images/research-page/custom.jpg",
    citation: {
      vancouver:
...

  {
    ...
    authors: "We offer top notch A to Z game development services for multiple platforms ranging from mobile and web to desktop and consoles. ",
    conferences:
      "• PC Games • Console Games • AAA Games • Mobile Games • Casual Games • Unity Development • Unreal Engine Development",
    researchYr: "",
    citebox: "popup6",
    image: "assets/images/research-page/game.png",
    citation: {
      vancouver:
...

  {
    ...
    researchYr: "",
    citebox: "popup7",
    image: "assets/images/research-page/block.jpg",
    citation: {
      vancouver:
  ...
  },
  {
    ...
    authors:
      "We develop artificial intelligence responsibly in order to benefit people and society.",
    conferences:
      "• Image recognition • Object detection • Image Enhancement • Trading Bot • Chat Bot",
    researchYr: "",
    citebox: "popup8",
